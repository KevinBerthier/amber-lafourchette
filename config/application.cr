...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Amber Lafourchette web application."
  #
  #
  ...
  #
  # settings.secret_key_base= iEc6xHvN2l-9AciAG8BrDr6Od9YYjpul1hgNs7xPN-w
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("amber-lafourchette.log", "w"))
  #
  #
end
